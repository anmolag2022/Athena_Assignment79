// src/pages/Admin.js or src/components/Admin.js
...
const Admin = () => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "Messages":
        return <div><h3>Messages Inbox</h3><p>No new messages at the moment.</p></div>;
      ...
      case "Resumes":
        return <div><h3>Resume Submissions</h3><p>5 new resumes uploaded today.</p></div>;

      case "Leave Management":
        return <div><h3>Leave Requests</h3><p>All leave requests are approved.</p></div>;

      case "Performance Management":
        return <div><h3>Performance Reports</h3><p>Performance reviews will be conducted next month.</p></div>;
